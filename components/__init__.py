...
class Vm:
    ...
    - OS (Type[management.Os]): operating system which determines creation and execution of applications
    """
    NAME: str
    CPU: int
    RAM: int
    OS: Type[management.Os]
...
class Pm:
    ...
    - RAM (int): amount of RAM in megabytes
    - VMM (Type[management.Vmm]): hypervisor which determines creation and execution of virtual machines
    """
    NAME: str
    CPU: tuple[int, ...]
    RAM: int
    VMM: Type[management.Vmm]
...
class DataCenter:
    ...
    - PLACEMENT (Type[management.Placement]): management utility which determines assignment of virtual machines to physical machines
    """
    NAME: str
    SERVERS: list[Pm, ...]
    PLACEMENT: Type[management.Placement]
